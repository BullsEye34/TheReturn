...
public class Player : MonoBehaviour
{
    ...
    public bool CanUseItem(GameController controller, Item item){
        ...
        if(HasItem(item.targetItem, controller)){
            return true;
        }
        if(currentLocation.HasItem(item.targetItem,controller)){
            return true;
        }
    ...
    public bool CanReadItem(GameController controller, Item item){
     ...
     private bool HasItem(Item itemToCheck, GameController controller){
